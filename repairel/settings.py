"""
Django settings for repairel project.
...
INSTALLED_APPS = [
    ...
    'repairelapp.apps.RepairelappConfig',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'repairel.context_processors.cart',
            ],
        },
    },
]

WSGI_APPLICATION = 'repairel.wsgi.application'
